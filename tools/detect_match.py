...
model = YOLO("models/match/best.pt")

interval = 30
start_frame = 0
src_dir = '/Users/maoh_ika/Downloads/movies'
dst_dir = '/Users/maoh_ika/Downloads/match'
...
for path in paths:
    ...
    while True:
        ...
        if len(boxes) > 0:
            ...
            txt_img_path = f'{dst_dir}/{image_name}_{frame}.txt'
            img_out_path =f'{dst_dir}/{image_name}_{frame}.jpg'
